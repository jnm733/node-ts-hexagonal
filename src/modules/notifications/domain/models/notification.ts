import IDomainValidator, {IDomainValidatorResult} from "@/framework/domain/validation/iDomainValidator";
import {AggregateRoot} from "@/framework/domain/aggregate/aggregateRoot";
...
export default class Notification extends AggregateRoot<Notification>{

    private validator: IDomainValidator;
    ...
    private constructor(params: any, validator: IDomainValidator, id?: number) {
    ...
    public static create(params: any, validator: IDomainValidator, id?: number): Notification | undefined {

        const notification = new this(params, validator);
