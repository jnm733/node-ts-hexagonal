import {ICriteria, ICriteriaAPI, ICriteriaOrder, orderDirection} from "@/framework/modules/framework/domain/criteria/iCriteria";
...
export default class Criteria implements ICriteria{
    ...
    public static parseFromQueryDict(query: ICriteriaAPI): Criteria {
