...
import healthRoutes from "@/framework/modules/framework/infrastructure/express/routes/health";
...
export default class ExpressServer implements IExpressServer{
    ...
    constructor( public configuration: IConfiguration, public router: Router) {
        this.app = express();
    }
